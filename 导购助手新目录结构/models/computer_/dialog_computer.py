...
from static_data_computer import necessaryTag, labelToTag, ask_slot, listInfo, nameToColumn
from static_data_computer import adjustableSlot, whatever_word, yes_word, no_word
from static_data_computer import experienceAttr, game, gameRequirement
...
class Computer_Dialogue():
    ...
    def init(self, sentence):
        self.responsePrefix = '欢迎来到电脑导购助手！'
        self.changeState('ask')
        self.ask(sentence)
    ...
    def getResult(self):
        returnSlot = ['name', 'price', 'memory', 'disk', 'cpu', 'gpu']
        res = []
