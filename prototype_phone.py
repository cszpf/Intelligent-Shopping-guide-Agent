import numpy as np
from nluInterface import getIntent,getSlotIntent,getSlot,getChangeIntent
...
class phoneDialog():
    ...
    def adjustConfirm(self,sentence):
        ...
        if intent == 'answer_yes': 
            ...
            answer_intent = getSlotIntent(sentence)
            negative = False
    ...
    def extract(self,sentence):
        tag = getSlot('phone',sentence)['entities']
