...
# informable slot的回复
listInfo = {'brand': ['畅销的品牌有联想,惠普,戴尔,华硕呢', '比较畅销的牌子有联想,惠普,戴尔,华硕等'],
            'price': ['一般常见的价位有3000以下,3000-7000或者以上的呢','便宜的产品大约是3000以下，中等的产品是5000左右，高端产品会更贵哦～'],
            'memory': ['常见的内存规格分为4G，6G，8G,16G等等','常见的有4G,8G等等，一般来说8G就可以流畅运行了哦~']}
