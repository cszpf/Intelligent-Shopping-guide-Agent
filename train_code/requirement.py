...
# NLU_path = 'D:\\pythonWorkPrpject\\Intelligent-Shopping-guide\\NLU'
...
def train():
    print('read data...')
    data = pd.read_csv('./data/requirement_data.csv')
    ...
    classifier_model = XGBClassifier(learning_rate=0.5,
                              n_estimators=50,  # 树的个数--1000棵树建立xgboost 330
                              max_depth=2,  # 树的深度
...
def get_requirement(sentence):
    model_path = CONFIG.NLU_path + '\\Requirement_part\\model\\model.pk'
