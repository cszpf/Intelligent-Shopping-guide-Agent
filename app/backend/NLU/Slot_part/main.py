...
flags.DEFINE_string("train_file",   os.path.join("data", "data_train.txt"),  "Path for train data")
flags.DEFINE_string("dev_file",     os.path.join("data", "data_dev.txt"),    "Path for dev data")
flags.DEFINE_string("test_file",    os.path.join("data", "data_test.txt"),   "Path for test data")
